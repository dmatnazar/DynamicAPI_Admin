...
export function DashboardPage() {
  ...
  const connected = tenants.filter((t) => t.connectionStatus === 'success').length;
  const failed = tenants.filter((t) => t.connectionStatus === 'failed').length;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="rounded-xl border border-surface-border bg-surface-card p-4 sm:p-5">
          ...
          <ol className="list-decimal list-inside text-sm text-neutral-400 space-y-1.5">
            <li>Add a company with its MSSQL connection in the Companies tab.</li>
